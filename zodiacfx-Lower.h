...
#ifndef _BACKENDS_ZODIACFX_LOWER_H_
#define _BACKENDS_ZODIACFX_LOWER_H_
...
/**
  This pass rewrites expressions which are not supported natively on ZODIACFX.
*/
...
#endif  /* _BACKENDS_ZODIACFX_LOWER_H_ */
