...
#include "extensions/p4c-zodiacfx/version.h"
#include "ir/ir.h"
#include "lib/log.h"
#include "lib/crash.h"
...
void compile(ZodiacfxOptions& options) {
    ...
    ZODIACFX::run_zodiacfx_backend(options, toplevel, &midend.refMap, &midend.typeMap);
}
...
int main(int argc, char *const argv[]) {
    ...
    AutoCompileContext autoZodiacfxContext(new ZodiacfxContext);
    auto& options = ZodiacfxContext::get().options();
    options.compilerVersion = P4C_ZODIACFX_VERSION_STRING;
